...
IBM-Provision-Capability: \
  ...
  osgi.identity; filter:="(&(type=osgi.subsystem.feature)(|(osgi.identity=com.ibm.websphere.appserver.mpMetrics-2.3)(osgi.identity=com.ibm.websphere.appserver.mpMetrics-3.0)(osgi.identity=io.openliberty.mpMetrics-4.0)(osgi.identity=io.openliberty.mpMetrics-5.0)))"
